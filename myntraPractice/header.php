<div id="nav_up">
    <div id="navbar">
      <div class="parent-box-1">
        <div class="logo_div">
          <a href="#"> <img id="logo"
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS357fHYAnvyZIqrnolaRs3MlCQO7PyKngEag&usqp=CAU" /></a>
        </div>
      ...
      <div class="parent-box-2">
        ...
        <div id="other_div">
              ...
              <div id="content7">
                <div id="b">
                  <div class="div" id="d1">
                    ...
                    <button id="ls"><a id="logincss" href="./loginSignup/login.php">LOGIN / SIGNUP</a></button>
                    <br>
                    <hr>
                    <ul>
                    ...
                    <ul>
                      ...
                      <li><a href="#">Saved Address</a></li> </ul>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            <a href="#"><i class="fa-solid fa-heart font" id="i1"><span
                  id="count_wish"><span></i></a><br>
            <a id="wishlist_tag" href="#">Whishlist</a>
          </div>

          <div>
            <a id="count" href="#"> <i class="fa-solid fa-bag-shopping font " id="i1"><span
                  id="count_cart"></span></i></a>
